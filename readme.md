...
# 主な修正
- LazyERBのゲーム推奨設定とプレイヤー設定を分けました。設定画面の「起動」タブから対象フォルダを変更でき、ゲーム推奨設定へ戻すこともできます。変更は次回起動後に反映されます。（設定UIの正式配布版への反映は未実施です。）
...
# 配布フォルダについて
『配布/Emuera.NET_最終通常版』には、2026-09-15更新のM3A/M4A反映版.NET 10正式single-file EXEを置いています。
...
- 『Emuera.exe』: 配布用実行ファイル（24,684,266バイト、SHA-256 `B68A494119816D4D788F5B7A5B56AC786BA45B179D0EE00304F283E561B388CF`、ProductVersion `0.2.6.0+a63b594237825f4b6a9e5335ed13f4ea32175c0a`）
- 『README.md』: 導入方法と採用機能
- 『SHA256SUMS.txt』: 配布物の改ざん確認用ハッシュ

変更の流れは[更新履歴](更新履歴.md)、現行正式版の変更理由と検証結果は`プロジェクト資料/修正履歴/#今回の修正説明_2026-09-15.md`を参照してください。

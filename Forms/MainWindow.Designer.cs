...
namespace MinorShift.Emuera.Forms
{
	partial class MainWindow
	{
		...
		private void InitializeComponent()
		{
			...
			this.rebootToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.rebootToolStripMenuItem.Text = "再起動(&R)";
			this.rebootToolStripMenuItem.Click += new System.EventHandler(this.rebootToolStripMenuItem_Click);
			// 
			// ログを保存するSToolStripMenuItem
			// 
			this.ログを保存するSToolStripMenuItem.Name = "ログを保存するSToolStripMenuItem";
			this.ログを保存するSToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.ログを保存するSToolStripMenuItem.Text = "ログを保存する...(&S)";
			...
			this.ログをクリップボードにコピーToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.ログをクリップボードにコピーToolStripMenuItem.Text = "ログをクリップボードにコピー(&C)";
			...
			this.タイトルへ戻るTToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.タイトルへ戻るTToolStripMenuItem.Text = "タイトル画面へ戻る(&T)";
			...
			this.コードを読み直すcToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.コードを読み直すcToolStripMenuItem.Text = "全コードを読み直す(&C)";
			...
			this.フォルダを読み直すFToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.フォルダを読み直すFToolStripMenuItem.Text = "フォルダを読み直す(&F)";
			...
			this.ファイルを読み直すFToolStripMenuItem.Size = new System.Drawing.Size(262, 22);
			this.ファイルを読み直すFToolStripMenuItem.Text = "ファイルを読み直す(&A)";
			...
			this.デバッグウインドウを開くToolStripMenuItem.Size = new System.Drawing.Size(268, 22);
			this.デバッグウインドウを開くToolStripMenuItem.Text = "デバッグウインドウを開く";
			...
			this.デバッグ情報の更新ToolStripMenuItem.Size = new System.Drawing.Size(268, 22);
			this.デバッグ情報の更新ToolStripMenuItem.Text = "デバッグ情報の更新";
			...
			this.コンフィグCToolStripMenuItem.Size = new System.Drawing.Size(118, 22);
			this.コンフィグCToolStripMenuItem.Text = "設定(&C)";
			...
			this.EmuVerToolStripTextBox.Size = new System.Drawing.Size(160, 22);
			...
			// folderSelectDialog
			// 
			this.folderSelectDialog.Description = "読み直すフォルダを選択してください";
			// 
			// richTextBox1
			// 
			...
			this.マクロ01ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ01ToolStripMenuItem.Tag = "";
			this.マクロ01ToolStripMenuItem.Text = "マクロ01";
			// 
			...
			this.マクロ02ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ02ToolStripMenuItem.Text = "マクロ02";
			// 
			...
			this.マクロ03ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ03ToolStripMenuItem.Text = "マクロ03";
			// 
			...
			this.マクロ04ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ04ToolStripMenuItem.Text = "マクロ04";
			// 
			...
			this.マクロ05ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ05ToolStripMenuItem.Text = "マクロ05";
			// 
			...
			this.マクロ06ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ06ToolStripMenuItem.Text = "マクロ06";
			// 
			...
			this.マクロ07ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ07ToolStripMenuItem.Text = "マクロ07";
			// 
			...
			this.マクロ08ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ08ToolStripMenuItem.Text = "マクロ08";
			// 
			...
			this.マクロ09ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ09ToolStripMenuItem.Text = "マクロ09";
			// 
			...
			this.マクロ10ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ10ToolStripMenuItem.Text = "マクロ10";
			// 
			...
			this.マクロ11ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ11ToolStripMenuItem.Text = "マクロ11";
			// 
			...
			this.マクロ12ToolStripMenuItem.Size = new System.Drawing.Size(155, 22);
			this.マクロ12ToolStripMenuItem.Text = "マクロ12";
			// 
			...
			this.グループ0ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ0ToolStripMenuItem.Tag = "0";
			this.グループ0ToolStripMenuItem.Text = "グループ0";
			...
			this.グループ1ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ1ToolStripMenuItem.Tag = "1";
			this.グループ1ToolStripMenuItem.Text = "グループ1";
			...
			this.グループ2ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ2ToolStripMenuItem.Tag = "2";
			this.グループ2ToolStripMenuItem.Text = "グループ2";
			...
			this.グループ3ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ3ToolStripMenuItem.Tag = "3";
			this.グループ3ToolStripMenuItem.Text = "グループ3";
			...
			this.グループ4ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ4ToolStripMenuItem.Tag = "4";
			this.グループ4ToolStripMenuItem.Text = "グループ4";
			...
			this.グループ5ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ5ToolStripMenuItem.Tag = "5";
			this.グループ5ToolStripMenuItem.Text = "グループ5";
			...
			this.グループ6ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ6ToolStripMenuItem.Tag = "6";
			this.グループ6ToolStripMenuItem.Text = "グループ6";
			...
			this.グループ7ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ7ToolStripMenuItem.Tag = "7";
			this.グループ7ToolStripMenuItem.Text = "グループ7";
			...
			this.グループ8ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ8ToolStripMenuItem.Tag = "8";
			this.グループ8ToolStripMenuItem.Text = "グループ8";
			...
			this.グループ9ToolStripMenuItem.Size = new System.Drawing.Size(131, 22);
			this.グループ9ToolStripMenuItem.Tag = "9";
			this.グループ9ToolStripMenuItem.Text = "グループ9";
			...
			this.切り取り.Size = new System.Drawing.Size(146, 22);
			this.切り取り.Text = "切り取り";
			...
			this.コピー.Size = new System.Drawing.Size(146, 22);
			this.コピー.Text = "コピー";
			...
			this.貼り付け.Size = new System.Drawing.Size(146, 22);
			this.貼り付け.Text = "貼り付け";
			...
			this.削除.Size = new System.Drawing.Size(146, 22);
			this.削除.Text = "削除";
			...
			this.実行.Name = "実行";
			this.実行.Size = new System.Drawing.Size(146, 22);
			this.実行.Text = "実行";
